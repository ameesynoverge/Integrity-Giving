...
public class OfferListActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		arrayListOfferDisplayDetail = (ArrayList<OfferDisplayDetail>) getIntent()  
				.getExtras().get("offer_from_map");
		...
		if (arrayListOfferDisplayDetail != null
			...
			listOffers.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> adapterView, View arg1,
					...
					Intent intent = new Intent(OfferListActivity.this,
		...
		searchView.setOnQueryTextListener(new OnQueryTextListener() {
			...
			public boolean onQueryTextSubmit(String query) {
				...
				InputMethodManager inputManager = (InputMethodManager) OfferListActivity.this
	...
	private OnMarkerClickListener markerClickListener = new OnMarkerClickListener() {
		...
		public boolean onMarkerClick(Marker marker) {
			...
			if (popupWindow == null) {
				...
				popupWindow = new PopupWindow(OfferListActivity.this);
